...
from ml.clustering.inference.llm_summarizer import load_llm_config, generate_analysis_report
...
def generate_report(config: dict, predictor: Predictor, df_input: pd.DataFrame, summarize: bool = False):
    ...
    aliases = load_yaml_map(os.path.join('ml/core/configs/clustering', 'cluster_aliases.yaml'))
