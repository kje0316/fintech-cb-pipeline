...
def run_lake_to_dwh2():
    ...
    from etl.lake_to_dwh2.run_pipe import run_pipeline
    run_pipeline()
...
#     from etl.dwh_to_dm.scripts.derived_dm import main as build_dm
...
def run_dwh_to_dm():
    ...
    from etl.dwh_to_dm.scripts.derived_dm import main
    main()
